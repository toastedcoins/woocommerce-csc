<?php
/**
 * Plugin Name: WooCommerce CSC
 * Plugin URI: http://github.com/empatogen/woocommerce-csc
 * Description: A payment gateway for WooCommerce to accept <a href="https://ripple.com/csc">CSC</a> payments.
 * Version: 1.1.2
...
/* define constants */
define('WCCSC_VERSION', '1.1.2');
define('WCCSC_TEXTDOMAIN', 'wc-gateway-csc');
define('WCCSC_NAME', 'Woocommerce CSC');
...
function wc_gateway_csc_checkout_handler()
{
    ...
    $csc_total    = round($order->get_meta('total_amount', true), 6);
    $csc_received = round($order->get_meta('delivered_amount', true), 6);
    $remaining    = round((float)$csc_total - (float)$csc_received, 6);
