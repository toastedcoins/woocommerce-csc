...
class WC_Gateway_CSC extends \WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_title       = __('CSC', 'wc-gateway-csc');
...
//            'stex'  => 'stex.com',
    ...
    */
    ...
    {
        _e('<div class="notice notice-error"><p><b>WooCommerce CSC</b> does not support the <b>currency</b> your shop is using.</p></div>', 'wc-gateway-csc');
    }
    ...
    */
    ...
    {
        _e('<div class="notice notice-error"><p><b>WooCommerce CSC</b> requires you to specify a <b>CSC Account</b> and your <b>CSCL Webhook</b> details.</p></div>', 'wc-gateway-csc');
    }
    ...
    */
    ...
    {
        _e('<div class="notice notice-error"><p>The specified <b>CSC Account</b> and/or <b>CSCL Webhook</b> details are invalid. Please correct these for <b>WooCommerce CSC</b> to work properly.</p></div>', 'wc-gateway-csc');
    }
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = apply_filters('wc_csc_form_fields', [
            ...
            'cscl_webhook' => [
                ...
                'type'        => 'title',
                'description' => __('In order to create your webhook and process your payments properly, please specify your CSCL Webhooks API key. For more informations how to obtain these keys, please visit <a href="https://webhook.casinocoin.eu/">https://webhook.casinocoin.eu</a>.', 'wc-gateway-csc')
            ],
            ...
            'csc_node' => [
                ...
                'default'     => 'https://ws01.casinocoin.org:5005',
                'placeholder' => 'https://ws01.casinocoin.org:5005',
                'desc_tip'    => true
            ],
            'csc_bypass' => [
    ...
    */
    public function check_ledger()
    {
        ...
        foreach ($trans as $tx) {
            ...
            $delivered_drops  = $delivered_csc * 1000000;

            /* update current payment */
            $delivered_drops += $tx->meta->delivered_amount;
            $delivered_csc    = $delivered_drops / 1000000;
